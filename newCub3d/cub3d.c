...
/*   Updated: 2023/10/27 23:44:22 by ahajji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    check_rays_draw(t_cub3d *data, float ray_angle)
{
    float   second_pointy;
    float   second_pointx;
...
if(ray_angle > 0 && ray_angle  < 180)
{
    ...
    while (myMap[(int)(hores_inters_y / size_shape)][(int)(hores_inters_x / size_shape)] != '1')
    {
...
else
{
   ...
   draw_line_dda(data, data->px, data->py, next_ver_inters_x, next_ver_inters_y, 0xFF0000FF); 
}
...
void    draw_view_angle(t_cub3d *data)
{
    ...
    while (i < data->number_rays)
    {
        if (ray_angle >= 360)
            ray_angle = 0;
        check_rays_draw(data, ray_angle);
